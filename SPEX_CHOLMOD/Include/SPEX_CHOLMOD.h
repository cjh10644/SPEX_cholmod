//------------------------------------------------------------------------------
// SPEX_CHOLMOD/Include/SPEX_CHOLMOD.h: user #include file for SPEX CHOLMOD.
//------------------------------------------------------------------------------
...
#ifndef SPEX_CHOLMOD_H
#define SPEX_CHOLMOD_H
...
#define SPEX_CHOLMOD_VERSION "1.0.0"
#define SPEX_CHOLMOD_VERSION_MAJOR 1
#define SPEX_CHOLMOD_VERSION_MINOR 0
#define SPEX_CHOLMOD_VERSION_SUB   0

//------------------------------------------------------------------------------
// Error codes
//------------------------------------------------------------------------------

// Most SPEX_CHOLMOD functions return a code that indicates if it was successful
...
SPEX_info SPEX_matrix_alloc
(
    SPEX_matrix **A_handle,      // matrix to be allocated
...
*/
#define SPEX_2D(A,i,j) (A[(i)+(j)*(3)-1])
//------------------------------------------------------------------------------
// Memory management
//------------------------------------------------------------------------------
