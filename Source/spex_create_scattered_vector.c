...
// Purpose: This function is called to create and initialize a scattered mpz vector with given size n. Both mpz_t vector and the nnz pattern vector are allocated with length n.
