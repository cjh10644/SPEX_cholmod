...
)
{
    ...
    SPEX_CHECK(SPEX_mpz_divexact(sd[tmp_ks], d[tmp_ks], SPEX_MPQ_DEN(SPEX_2D(S,3,tmp_ks))));
    SPEX_CHECK(SPEX_mpz_mul     (sd[tmp_ks],sd[tmp_ks], SPEX_MPQ_NUM(SPEX_2D(S,3,tmp_ks))));
